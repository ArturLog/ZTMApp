...
export function DraggableStopList({ stops, onReorder }: DraggableStopListProps) {
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <Droppable droppableId="myStops" isDropDisabled={false} isCombineEnabled={false} ignoreContainerClipping={false}>
        {(provided) => (
